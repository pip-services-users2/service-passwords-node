# Deployment Guide <br/> Passwords Microservice
...
let plugin = require('service-passwords-node').PasswordsSenecaPlugin;
...
or by using [PasswordsSenecaClient](https://github.com/pip-services-users2/client-passwords-nodex/NodeClientApiV1.md/#client_seneca)